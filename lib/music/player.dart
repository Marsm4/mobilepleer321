...
class _PlayerPageState extends State<PlayerPage> {
  ...
  double _volume = 1.0; // Переменная для громкости
  ...
  Future initPlayer() async {
    ...
    audioPlayer.setVolume(_volume); // Устанавливаем громкость при инициализации
  }
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  SizedBox(width: 10),
                  SizedBox(
                    width: MediaQuery.of(context).size.width * 0.6, // Уменьшаем размер слайдера
                    child: Slider(
                      value: _volume,
                      min: 0.0,
                      max: 1.0,
                      ...
                      onChanged: (value) async {
                        ...
                        await audioPlayer.setVolume(_volume); // Устанавливаем громкость
                      },
                    ),
                  ),
                ],
